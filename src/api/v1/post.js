...
export default function postApiV1Actions (sqlDatabase) {
    ...
    // ...
    const requestContactByAccountNumber = (req, res, _) => {
    ...
    // ...
    const requestContact = (req, res, _) => {
    ...
    // ...
    const updateExtContact = (req, res, _next) => {
    ...
    // ...
    const updateContact = (req, res, _next) => {
                ...
                return t.batch([
                    ...
                    req.body.status === 2 ? // ACCEPTED - insert reciprocal accept
                        (() => {
                             ...
                             * don't do anything.
                             */
                            sqlDatabase.oneOrNone("SELECT id FROM contacts \
                            WHERE contact_id = ${contact_id} \
                            AND requested_by = ${requested_by} \
                            AND status = 2",
                            {
                                ...
                                result ? null : (
                                    sqlDatabase.one("INSERT INTO contacts(contact_id, \
    ...
    // ...
    const deleteContact = (req, res, _next) => {
    ...
    // ...
    const deleteExtContact = (req, res, _next) => {
    ...
    // ...
    const updateAccount = (req, res, _next) => {
    ...
    // ...
    const externalContacts = (req, res, next) => {
    ...
    // ...
    const contactReqlist = (req, res, next) => {
